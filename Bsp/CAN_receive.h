...
typedef enum
{
    ...
    //CAN_MAGAZINE_MOTOR_ID = 0x207,
    CAN_TRIGGER_MOTOR_ID = 0x208,

    CAN_CGIMBAL_ALL_ID = 0x1FF,

    //CAN_cYAW_MOTOR_ID = 0x209,
...
extern void CAN_cmd_cgimbal(int16_t yaw, int16_t pitch, int16_t shoot, int16_t rev);
