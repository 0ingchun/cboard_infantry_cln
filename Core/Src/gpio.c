...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, USER_SPI_CS_Pin|CS1_GYRO_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = DRDY_IST8310_Pin|SOFT_INT_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = USER_SPI_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(USER_SPI_CS_GPIO_Port, &GPIO_InitStruct);
